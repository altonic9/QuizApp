...
public class ProfileManagmentController {
    ...
    void deleteProfile(ActionEvent event) {
        ...
        if (selectedItem < 0) {
            GuiUtility.showAlert("Missing Information", "Please choose Profile");
            return;
        }
    ...
    void changeName(ActionEvent event) {
        ...
        while (Profile.exists(editName.getText())){
            GuiUtility.showAlert("Missing Information", "Name is not availible!");
            return;
        }
        if (event.getSource() == changeNameBTN && editName.getText().isEmpty()){
            GuiUtility.showAlert("Missing Information", "Please Enter a Name!");
            return;
        }
